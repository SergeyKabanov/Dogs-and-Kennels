...
extern const MIDL_SERVER_INFO Idog_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO Idog_ProxyInfo;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO Ikennel_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO Ikennel_ProxyInfo;
...
/* 66 */	NdrFcLong( 0x77ccbbe1 ),	/* 2009906145 */
/* 70 */	NdrFcShort( 0x3699 ),	/* 13977 */
/* 72 */	NdrFcShort( 0x11d5 ),	/* 4565 */
/* 74 */	0xae,		/* 174 */
			0xa3,		/* 163 */
/* 76 */	0x0,		/* 0 */
			0xa0,		/* 160 */
...
/* Object interface: Idog, ver. 0.0,
   GUID={0x77CCBBE1,0x3699,0x11D5,{0xAE,0xA3,0x00,0xA0,0xD2,0x16,0x26,0x38}} */

#pragma code_seg(".orpc")
static const unsigned short Idog_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO Idog_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &Idog_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO Idog_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(16) _IdogProxyVtbl = 
{
    &Idog_ProxyInfo,
    &IID_Idog,
    ...
    (void *) (INT_PTR) -1 /* Idog::Run */ ,
    (void *) (INT_PTR) -1 /* Idog::Bark */ ,
    (void *) (INT_PTR) -1 /* Idog::Sleep */ ,
    (void *) (INT_PTR) -1 /* Idog::get_Breed */ ,
    (void *) (INT_PTR) -1 /* Idog::put_Breed */ ,
    (void *) (INT_PTR) -1 /* Idog::get_Name */ ,
    (void *) (INT_PTR) -1 /* Idog::put_Name */ ,
    (void *) (INT_PTR) -1 /* Idog::get_HairColor */ ,
    (void *) (INT_PTR) -1 /* Idog::put_HairColor */
};


static const PRPC_STUB_FUNCTION Idog_table[] =
{
...
CInterfaceStubVtbl _IdogStubVtbl =
{
    &IID_Idog,
    &Idog_ServerInfo,
    16,
...
/* Object interface: Ikennel, ver. 0.0,
   GUID={0xF77A0781,0x369E,0x11D5,{0xAE,0xA3,0x00,0xA0,0xD2,0x16,0x26,0x38}} */

#pragma code_seg(".orpc")
static const unsigned short Ikennel_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO Ikennel_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &Ikennel_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO Ikennel_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(11) _IkennelProxyVtbl = 
{
    &Ikennel_ProxyInfo,
    &IID_Ikennel,
    IUnknown_QueryInterface_Proxy,
    ...
    0 /* (void *) (INT_PTR) -1 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* Ikennel::Save */ ,
    (void *) (INT_PTR) -1 /* Ikennel::Load */ ,
    (void *) (INT_PTR) -1 /* Ikennel::GetCount */ ,
    (void *) (INT_PTR) -1 /* Ikennel::GetAt */
};


static const PRPC_STUB_FUNCTION Ikennel_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IkennelStubVtbl =
{
    &IID_Ikennel,
    &Ikennel_ServerInfo,
    11,
...
const CInterfaceProxyVtbl * _DOGS_INNER_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IkennelProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IdogProxyVtbl,
    0
};

const CInterfaceStubVtbl * _DOGS_INNER_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IkennelStubVtbl,
    ( CInterfaceStubVtbl *) &_IdogStubVtbl,
    0
...
PCInterfaceName const _DOGS_INNER_InterfaceNamesList[] = 
{
    "Ikennel",
    "Idog",
    0
...
const IID *  _DOGS_INNER_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _DOGS_INNER_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _DOGS_INNER, pIID, n)

int __stdcall _DOGS_INNER_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _DOGS_INNER, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _DOGS_INNER, 2, *pIndex )
    
}

const ExtendedProxyFileInfo DOGS_INNER_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _DOGS_INNER_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _DOGS_INNER_StubVtblList,
    (const PCInterfaceName * ) & _DOGS_INNER_InterfaceNamesList,
    (const IID ** ) & _DOGS_INNER_BaseIIDList,
    & _DOGS_INNER_IID_Lookup, 
    2,
    2,
